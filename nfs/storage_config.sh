...
# IP-адрес SSH хоста (для доступа к серверам)
SSH_HOST="192.168.0.106"

# Базовый путь для монтирования дисков
MOUNT_BASE="/mnt/data_storage"

# Массив дисков для монтирования (формат: сервер:uuid)
DISKS_TO_MOUNT=(
    "192.168.0.106:65135f15-6654-47b0-8e70-6f1a2485e8c2"
)
